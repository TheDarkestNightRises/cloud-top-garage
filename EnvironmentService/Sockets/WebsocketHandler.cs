...
namespace WebSocketClient
{
    class WebsocketClient : WebSocketHandler
    {
        ...
        {
            server.SendAsync(new ArraySegment<byte>(Encoding.UTF8.GetBytes("WebSocket Listener has been opened for requests.")), WebSocketMessageType.Text, true, CancellationToken.None);
        }
